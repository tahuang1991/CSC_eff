...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,EI,PAT,DQM:@allForPrompt --runUnscheduled --nThreads 4 --data --era Run2_2017 --scenario pp --conditions 92X_dataRun2_Prompt_v4_TrackerUpdatedConditions_forTestsONLY --eventcontent AOD,MINIAOD,DQM --datatier AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --filein file:pippo.root -n 100 --python_filename=recoskim_Run2017B_SingleMuon.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/hdfs/store/user/senka/CSC_2017data/1670035E-CD52-E711-AA85-02163E014522.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '92X_dataRun2_Prompt_v4_TrackerUpdatedConditions_forTestsONLY', '')
