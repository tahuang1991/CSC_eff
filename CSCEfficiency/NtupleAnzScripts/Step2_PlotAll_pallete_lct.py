...
#TagProbeFitResult="2015D_1011_LCT_newAlign_withHLTIsoTkMu_matchOtherStationsORME13_chambers_noVMEprob259891/TnP_"+dir_+"_"
#TagProbeFitResult="2015B_newAlign_2/TnP_"+dir_+"_"
...
if "Stations" in Group:
    ...
    SEGEff=TH2F("SEGEff","CSC segment efficiency",36,1,37,20,-9,9)
...
#    LCTEff.SetTitle("")
  ...
  #split tree to chamber
    ...
    file_out.cd()
#    SegCanvas.Write()
#    SegCanvas.SaveAs("SegCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.pdf")
#    SegCanvas.SaveAs("SegCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.root")
#    SegCanvas.SaveAs("SegCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.C")
    LCTCanvas.Write()
    LCTCanvas.SaveAs("LCTCanvas_2D_2016B_fixedLCT_LCT.pdf")
    LCTCanvas.SaveAs("LCTCanvas_2D_2016B_fixedLCT_LCT.root")
    LCTCanvas.SaveAs("LCTCanvas_2D_2016B_fixedLCT_LCT.C")
    SEGEff.Write()
    SEGEff_upErr.Write()
